    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>
                        لیست نظرات (تایید شده | تایید نشده)
                    </h2>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div style="width: 85%; margin: auto">
                                                    <div class="row">
                                                        ...
                                                        <br>
                                                        <strong id="status" style="padding-right: 15px"></strong>
                                                    </div>
                                                    ...
                                                    <div class="text-center" style="padding-bottom: 10px;">
                                                        <a id="display" class="btn btn-success">نمایش در سایت</a>
                                        ...
                                        $(".showcmnt").click(function () {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (data) {
                                                    $('#modal').modal('show');
                                                    $("#display").attr('href',"{{url('displaycomment')}}"+ "/" +data[0]['id']);
                                                    $("#trash").attr('href',"{{url('trashcomment')}}"+ "/" +data[0]['id']);
                                                    $("#modal-title").html(data[0]['post']);
                                                    $("#usrname").html(data[0]['name']);
                                                    $("#comment").html(data[0]['comment']);
                                                    $("#usremail").html(data[0]['email']);
                                                    if(data[0]['status']==0){
                                                        $("#status").html('تایید نشده');
                                                        $("#display").show();
                                                        $("#trash").show();
                                                    }
                                                    if(data[0]['status']==1){
                                                        $("#status").html('منتشر شده در سایت');
                                                        $("#display").hide();
                                                        $("#trash").show();
                                                    }
                                                    if(data[0]['status']==2){
                                                        $("#status").html('انتقال یافته به زباله دان');
                                                        $("#display").show();
                                                        $("#trash").hide();
                                                    }

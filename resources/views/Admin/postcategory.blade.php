...
@section('content')
    <div class="col-md-12 col-lg-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form action="{{route('postcat.store')}}" method="POST" class="form-horizontal form-label-left">
                    @csrf
                ...
                @foreach($parentCategories as $category)
                    <ul>
                        ...
                        @if(count($category->subcategory))
                            @include('admin.postsubCategoryList',['postsubCategoryList' => $category->subcategory])
                        @endif
                    </ul>
                    <hr>
                @endforeach
            ...
            $(".popupview").click(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var url = '{{ route("postcat.update", ":id") }}';
                        url = url.replace(':id', product_id);
                        var urll = '{{route("postcat.destroy", ":id")}}';

                        ...
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                <table id="datatable-keytable" class="table table-striped table-bordered">
                                    <thead>
                                    <tr >
                                        <th width="30%">نام محصول</th>
                                        <th width="25%">برند</th>
                                        <th width="7.5%">قیمت(تومان)</th>
                                        <th width="5%">تخفیف(درصد)</th>
                                        <th width="10%">وضعیت</th>
                                        <th width="22.5%">اعمال تغییرات</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @else
                                        <td class="text-center" style="color: #FF0000">ناموجود</td>
                                        @endif
                                        <td >
                                            <form action="{{route('product.destroy' , $product->id)}}" method="post">
                                                ...
                                                <a class="btn btn-xs btn-primary" href="{{route('product.edit',$product->id)}}"><i class="fa fa-edit"></i> ویرایش</a>
                                            </form>
